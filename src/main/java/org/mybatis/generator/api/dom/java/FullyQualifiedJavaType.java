...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
	...
	private void simpleParse(String typeSpecification) {
		...
		if (baseQualifiedName.endsWith("...")) {
			String qualifiedName = baseQualifiedName.substring(0, baseQualifiedName.indexOf("..."));
	...
	private static String getPackage(String baseQualifiedName) {
		if (baseQualifiedName.endsWith("...")) {
			baseQualifiedName = baseQualifiedName.substring(0, baseQualifiedName.indexOf("..."));
		}
