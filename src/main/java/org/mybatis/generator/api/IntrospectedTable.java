...
import org.mybatis.generator.config.BlankJavaClientGeneratorConfiguration;
import org.mybatis.generator.config.BlankSqlMapGeneratorConfiguration;
import org.mybatis.generator.config.Context;
import org.mybatis.generator.config.GeneratedKey;
import org.mybatis.generator.config.JavaClientGeneratorConfiguration;
import org.mybatis.generator.config.JavaControllerGeneratorConfiguration;
import org.mybatis.generator.config.JavaModelDtoGeneratorConfiguration;
...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		ATTR_BASE_RECORD_TYPE, ATTR_BASE_RECORD_DTO_TYPE,
		...
		ATTR_MYBATIS3_XML_MAPPER_PACKAGE, ATTR_MYBATIS3_BLANK_XML_MAPPER_PACKAGE,

		/** The ATT r_ mybati s3_ xm l_ mappe r_ fil e_ name. */
		ATTR_MYBATIS3_XML_MAPPER_FILE_NAME, ATTR_MYBATIS3_BLANK_XML_MAPPER_FILE_NAME,

		/** also used as XML Mapper namespace if a Java mapper is generated. */
		ATTR_MYBATIS3_JAVA_MAPPER_TYPE, ATTR_MYBATIS3_BLANK_JAVA_MAPPER_TYPE,

		/** also used as XML Mapper namespace if a Java service is generated. */
		ATTR_JAVA_SERVICE_IMPL_TYPE, ATTR_JAVA_SERVICE_INTERFACE_TYPE, ATTR_JAVA_CONTROLLER_TYPE,
	...
	public String getBaseRecordDtoType() {
		return internalAttributes.get(InternalAttribute.ATTR_BASE_RECORD_DTO_TYPE);
	}
	...
	public String getMyBatis3BlankSqlMapNamespace() {
		String namespace = getMyBatis3BlankJavaMapperType();
		if (namespace == null) {
			namespace = getMyBatis3FallbackSqlMapNamespace();
		}
	...
	public void initialize() {
		calculateBlankJavaClientAttributes();
	...
	protected void calculateXmlAttributes() {
		...
		setMyBatis3BlankXmlMapperPackage(calculateBlankSqlMapPackage());
		setMyBatis3BlankXmlMapperFileName(calculateMyBatis3BlankXmlMapperFileName());
	...
	protected String calculateBlankJavaClientInterfacePackage() {
		BlankJavaClientGeneratorConfiguration config = context.getBlankJavaClientGeneratorConfiguration();
		if (config == null) {
			return null;
		}
	...
	protected String calculateJavaServicePackage() {
		...
		StringBuilder sb = new StringBuilder();
		sb.append(config.getTargetPackage());
		sb.append("." + lowerCaseFirstChar(fullyQualifiedTable.getDomainObjectName()));
		sb.append(fullyQualifiedTable.getSubPackageForClientOrSqlMap(isSubPackagesEnabled(config)));
	...
	private String lowerCaseFirstChar(String property) {
		String c = property.charAt(0) + "";
		property = property.substring(1);
		return c.toLowerCase() + property;
	}
	...
	protected void calculateBlankJavaClientAttributes() {
		...
		sb.setLength(0);
		sb.append(calculateBlankJavaClientInterfacePackage());
		sb.append('.');
		if (stringHasValue(tableConfiguration.getMapperName())) {
			sb.append(tableConfiguration.getMapperName());
		} else {
		...
		setMyBatis3BlankJavaMapperType(sb.toString());
	}
	...
	protected void calculateJavaServiceAttributes() {
		...
		sb.append('.');
		sb.append("I" + fullyQualifiedTable.getDomainObjectName());
		sb.append("Service"); //$NON-NLS-1$
		setJavaServiceInterfaceType(sb.toString());

		sb.setLength(0);
		sb.append(calculateJavaServicePackage());
		sb.append("." + context.getJavaServiceGeneratorConfiguration().getImplementationPackage() + ".");
		sb.append(fullyQualifiedTable.getDomainObjectName());
	...
	protected String calculateJavaDtoPackage() {
		JavaModelDtoGeneratorConfiguration config = context.getJavaModelDtoGeneratorConfiguration();
		if (config == null) {
			return null;
		}
		StringBuilder sb = new StringBuilder();
	...
	protected void calculateDtoAttributes() {
		...
		if (pakkage != null) {
			...
			sb.append(fullyQualifiedTable.getDomainObjectName());
			sb.append("Dto");
			setBaseRecordDtoType(sb.toString());
		}
	}
	...
	protected String calculateBlankSqlMapPackage() {
		StringBuilder sb = new StringBuilder();
		BlankSqlMapGeneratorConfiguration config = context.getBlankSqlMapGeneratorConfiguration();
	...
	protected String calculateMyBatis3BlankXmlMapperFileName() {
		StringBuilder sb = new StringBuilder();
		if (stringHasValue(tableConfiguration.getMapperName())) {
			String mapperName = tableConfiguration.getMapperName();
			int ind = mapperName.lastIndexOf('.');
	...
	public abstract List<GeneratedXmlFile> getGeneratedBlankXmlFiles();
	...
	public void setBaseRecordDtoType(String baseRecordDtoType) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_RECORD_DTO_TYPE, baseRecordDtoType);
	}
	...
	public String getMyBatis3BlankXmlMapperPackage() {
		return internalAttributes.get(InternalAttribute.ATTR_MYBATIS3_BLANK_XML_MAPPER_PACKAGE);
	}
	...
	public void setMyBatis3BlankXmlMapperPackage(String mybatis3BlankXmlMapperPackage) {
		internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_BLANK_XML_MAPPER_PACKAGE, mybatis3BlankXmlMapperPackage);
	}
	...
	public String getMyBatis3BlankXmlMapperFileName() {
		return internalAttributes.get(InternalAttribute.ATTR_MYBATIS3_BLANK_XML_MAPPER_FILE_NAME);
	}
	...
	public void setMyBatis3BlankXmlMapperFileName(String mybatis3BlankXmlMapperFileName) {
		internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_BLANK_XML_MAPPER_FILE_NAME,
				mybatis3BlankXmlMapperFileName);
	}
	...
	public String getMyBatis3BlankJavaMapperType() {
		return internalAttributes.get(InternalAttribute.ATTR_MYBATIS3_BLANK_JAVA_MAPPER_TYPE);
	}

	public String getJavaServiceInterfaceType() {
		return internalAttributes.get(InternalAttribute.ATTR_JAVA_SERVICE_INTERFACE_TYPE);
	}
	...
	public void setMyBatis3BlankJavaMapperType(String mybatis3BlankJavaMapperType) {
		internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_BLANK_JAVA_MAPPER_TYPE, mybatis3BlankJavaMapperType);
	}

	public void setJavaServiceInterfaceType(String javaServiceInterfaceType) {
		internalAttributes.put(InternalAttribute.ATTR_JAVA_SERVICE_INTERFACE_TYPE, javaServiceInterfaceType);
	}
