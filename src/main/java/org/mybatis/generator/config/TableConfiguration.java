...
public class TableConfiguration extends PropertyHolder {
	...
	private List<ForeginKey> foreginKeys = new ArrayList<ForeginKey>();
	private AssociationRootTable associationRootTable;
	...
	public AssociationRootTable getAssociationRootTable() {
		return associationRootTable;
	}
	
	public void setAssociationRootTable(AssociationRootTable associationRootTable) {
		this.associationRootTable = associationRootTable;
	}
