...
public class PropertyRegistry {
	...
	public static final String ANY_ROOT_EXAMPLE_CLASS = "rootExampleClass";
	public static final String ANY_ROOT_CRITERIA_CLASS = "rootCriteriaClass";
	public static final String BASE_SQL_OPERATOR_CLASS = "BaseSqlOperatorClass";
	public static final String SEARCH_BEAN_CLASS = "SearchBeanClass";
	public static final String BASIC_EXCEPTION_CLASS = "BasicExceptionClass";
