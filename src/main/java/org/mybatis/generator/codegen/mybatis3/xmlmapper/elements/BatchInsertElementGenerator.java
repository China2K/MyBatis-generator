...
public class BatchInsertElementGenerator extends AbstractXmlElementGenerator {
	...
	public void addElements(XmlElement parentElement) {
		...
		String insertStatementId = introspectedTable.getInsertStatementId();
		answer.addAttribute(new Attribute("id", "batch" + insertStatementId.substring(0, 1).toUpperCase()
				+ insertStatementId.substring(1)));
		...
		List<IntrospectedColumn> columns = ListUtilities.removeIdentityAndGeneratedAlwaysColumns(introspectedTable
				.getAllColumns());
