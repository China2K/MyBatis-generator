...
public class BaseRecordGenerator extends AbstractJavaGenerator {
	...
	public List<CompilationUnit> getCompilationUnits() {
		...
		String rootClass = superClass.getFullyQualifiedName();
		...
		List<AssociationTable> associationTables = introspectedTable.getTableConfiguration().getAssociationRootTable()
				.getChildren();
		for (AssociationTable associationTable : associationTables) {
			String propertyName = associationTable.getMappedField();
			FullyQualifiedJavaType mappedType = associationTable.getMappedType();
			...
			getterMethod.setReturnType(mappedType);
			getterMethod.setName(JavaBeansUtil.getGetterMethodName(propertyName, mappedType));
			...
			setterMethod.setName(JavaBeansUtil.getSetterMethodName(propertyName));
			setterMethod.addParameter(new Parameter(mappedType, propertyName));
			sb.setLength(0);
