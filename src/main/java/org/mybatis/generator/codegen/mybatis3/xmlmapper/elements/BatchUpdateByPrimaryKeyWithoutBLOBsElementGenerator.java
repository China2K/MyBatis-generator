 ...
 * 
 */
public class BatchUpdateByPrimaryKeyWithoutBLOBsElementGenerator extends AbstractXmlElementGenerator {

	public BatchUpdateByPrimaryKeyWithoutBLOBsElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute("id", "batch" + upperCaseFirstChar(updateByPrimaryKeyStatementId)));
