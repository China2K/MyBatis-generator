 ...
 * 
 */
public class BatchUpdateByPrimaryKeyWithBLOBsMethodGenerator extends AbstractJavaMapperMethodGenerator {
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		if (introspectedTable.getRules().generateRecordWithBLOBsClass()) {
			modelType = new FullyQualifiedJavaType(introspectedTable.getRecordWithBLOBsType());
		} else {
		...
		method.setName("batch" + upperCaseFirstChar(updateByPrimaryKeyWithBLOBsStatementId));
